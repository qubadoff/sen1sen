...
class GeneralController extends Controller
{
    ...
    public function cv_upload(Request $request)
    {
        $request->validate([
            ...
            'education_school_name' => 'required|max:500',
            'speciality' => 'required|max:500',
            'computer_skills' => 'required|max:500',
            ...
            'father_name.max' => 'Father Name max 50 !',
